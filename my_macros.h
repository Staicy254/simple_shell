...
"If no argument provided to 'cd', command will be interpreted as follows:\n"\
"as cd $HOME.\n"\
...
"Modify or add environment variable.\n\n"\
"If no argument provided with 'cd' command, will be handled in following way:\n\
...
"Specified, offers comprehensive guidance on commands match BUILTIN_NAME, \n\
